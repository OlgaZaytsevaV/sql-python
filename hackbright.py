...
def make_new_student(first_name, last_name, github):
    ...
    db.session.commit()
    print("Student: {} {}\nGitHub account: {} added to to you students"
          .format(first_name, last_name, github))                                                   
...
def get_project_by_title(title):
    ...
    row = db_cursor.fetchone()
    print("Title : {}, description: {}, and max grade: {}".format(row[0],
          row[1], row[2]))
...
def assign_grade(github, title, grade):
    ...
    db.session.commit()    
    print("Github: {} Title : {} : grade : {} added to grades".format(github,
         title, grade))
